...
Revision ID: 7f709f2ae147
Revises: 472fa3a00aac
Create Date: 2020-08-13 17:00:48.267229
...
revision = '7f709f2ae147'
down_revision = '472fa3a00aac'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', mysql.INTEGER(display_width=11), autoincrement=True, nullable=False),
    sa.Column('ipaddress', mysql.VARCHAR(length=15), nullable=True),
    sa.Column('up', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('down', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('total_up', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('total_down', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('up_packets', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('down_packets', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('addtime', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset='utf8',
    mysql_engine='InnoDB'
    ...
    sa.Column('id', mysql.INTEGER(display_width=11), autoincrement=True, nullable=False),
    sa.Column('ipaddress', mysql.VARCHAR(length=15), nullable=True),
    sa.Column('one', mysql.FLOAT(precision=11, scale=2), nullable=True),
    sa.Column('five', mysql.FLOAT(precision=11, scale=2), nullable=True),
    sa.Column('fifteen', mysql.FLOAT(precision=11, scale=2), nullable=True),
    sa.Column('addtime', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset='utf8',
    mysql_engine='InnoDB'
    ...
    sa.Column('id', mysql.INTEGER(display_width=11), autoincrement=True, nullable=False),
    sa.Column('ipaddress', mysql.VARCHAR(length=15), nullable=True),
    sa.Column('read_count', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('write_count', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('read_bytes', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('write_bytes', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('read_time', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True),
    sa.Column('write_time', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True),
    sa.Column('addtime', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset='utf8',
    mysql_engine='InnoDB'
