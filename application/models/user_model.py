...
class UserModel(db.Model):
    ...
    thunderservice_client_amount = db.Column(db.Integer)
    thunderservice_traffic_amount = db.Column(db.BigInteger)
    thunderservice_up_traffic_used = db.Column(db.BigInteger)
    thunderservice_down_traffic_used = db.Column(db.BigInteger)
